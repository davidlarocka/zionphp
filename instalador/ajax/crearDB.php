...
$insert = "INSERT INTO t_usuarios (user_login,nombres, apellidos, cedula, rol, clave, id_psecreta, rsecreta, fecha_registro, fecha_expiracion  ) 
		   VALUES ('".$admin."', 'Administrador', 'ZionPHP', '0', '1', '".$clave_admin."', '1', 'zionphp', '".$fecha."', '2222-12-31' )";				
...
//==============vamos a usar una base de datos existente ===================================//	
