				            ...
				            <ul>
				                <li><a href="#" style="color:black;">Modulos</a>
									<ul>
				                        ...
				                        <li><a onclick="mostrarOpcionesEditarCU()" href="#">Editar</a></li>
				                    </ul>
				                </li>
				                <li><a href="#" style="color:black;">Menus</a>
									<ul>
				                        <li><a onclick="mostrarOpcionesMenus()" href="#"><span>Nuevo</span></a></li>
				...
				<table border="0">
					<tr height="200px">
						<td colspan="2">
						    ...
						    <div id="contenedor" name="contenedor"  class="visor_sucesos" style="display:none;" onmousedown="dragStart(event), this.id" >
