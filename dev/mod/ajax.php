	...
	//alert(descripcionModulo);
	 ...
	 function mostrarOpcionesMenus(){
		...
		var contenedor, area_opciones;
			...
			ajax=nuevoAjax();
			ajax.open('GET', 'mod/gestorMenus/interfazOpcionesMenus.php',true);
			ajax.onreadystatechange=function() {
			if (ajax.readyState==4) {
			contenedor.innerHTML += "<br/>>ZionPHP Dice: generando nuevo menu";
	  ...
	  function crearMenus(url, tipoMenus, nombreMenuCU, nombreMenuPadre ){
	//alert(descripcionModulo);
		...
		var contenedor, area_opciones;
			...
			ajax=nuevoAjax();
			ajax.open('GET', 'mod/gestorMenus/procesoCrearMenu.php?url='+url
															+'&nombreMenuCU='+nombreMenuCU
															+'&tipoMenus='+tipoMenus
															+'&nombreMenuPadre='+nombreMenuPadre,true);
			ajax.onreadystatechange=function() {
			if (ajax.readyState==4) {
			//contenedor.innerHTML += "<br/>>ZionPHP Dice: creando caso de uso...";
	 ...
	 function mostrarOpcionesEditarCU (){
	//alert(descripcionModulo);
		...
		var contenedor, area_opciones;
			...
			ajax=nuevoAjax();
			ajax.open('GET', 'mod/gestorCU/editarCU.php',true);
			ajax.onreadystatechange=function() {
			if (ajax.readyState==4) {
			//contenedor.innerHTML += "<br/>>ZionPHP Dice: editando caso de uso...";
	 ...
	 ///////////////////////////////mover visor//////////////////////////////////////
	  ...
	  function 	 eliminarCU(casosDeUso){
	//alert(descripcionModulo);
		...
		var contenedor, area_opciones;
			...
			ajax=nuevoAjax();
			ajax.open('GET', 'mod/gestorCU/procesoEliminarCU.php?casosDeUso='+casosDeUso,true);
			ajax.onreadystatechange=function() {
			if (ajax.readyState==4) {
			//contenedor.innerHTML += "<br/>>ZionPHP Dice: Eliminando caso de uso...";
