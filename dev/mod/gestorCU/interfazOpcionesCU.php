...
<table border="0" align="center" width="1000px" style="color:#2B2B2B;">
	...
	<tr>
		<td >
			...
			<input type="checkbox" name="consultas" id="consultas" value="consultas" checked="yes" />Consultas a la Base de Datos
			<br/>
			<br/> 
			<input type="checkbox" name="reportes" id="reportes" value="reportes" checked="no" />Reportes PDF
			<br/>
			<br/>
			<input type="checkbox" name="tecnoAjax" id="tecnoAjax" value="reportes" checked="no" />Ajax

			<br/>
			<br/>
		</td>
		<td valign="top">
			<b>Menus</b><br/><br/>Tipo de Menu
