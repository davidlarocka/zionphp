...
//===============================CONTENIDO FICHERO AJAX==================================================//

	
$contenidoAjax.="<script type=\"text/javascript\">\n";
$contenidoAjax.="//objeto ajax\n";
$contenidoAjax.="	function nuevoAjax(){\n";
$contenidoAjax.="		var xmlhttp=false;\n";
$contenidoAjax.=" 		try {\n";
$contenidoAjax.="	    xmlhttp = new ActiveXObject('Msxml2.XMLHTTP');\n";
$contenidoAjax.="       } catch (e) {\n";
$contenidoAjax.="       try {\n";
$contenidoAjax.="       xmlhttp = new ActiveXObject('Microsoft.XMLHTTP');\n";
$contenidoAjax.="       } catch (E) {\n";
$contenidoAjax.="       xmlhttp = false;\n";
$contenidoAjax.="       }\n";
$contenidoAjax.="       }\n";
$contenidoAjax.="		if (!xmlhttp && typeof XMLHttpRequest!='undefined') {\n";
$contenidoAjax.="		xmlhttp = new XMLHttpRequest();\n";
$contenidoAjax.="       }\n";
$contenidoAjax.="       return xmlhttp;\n";
$contenidoAjax.="       }\n\n";
$contenidoAjax.="	function ejemploAjax(){\n";
$contenidoAjax.="		div_respuesta_ajax = document.getElementById('div_respuesta_ajax');\n";
$contenidoAjax.="		ajax=nuevoAjax();\n";
$contenidoAjax.="		ajax.open('GET', 'ajax/ejemploAjax.php', true);\n";	
$contenidoAjax.="		ajax.onreadystatechange=function() {\n";	
$contenidoAjax.="		if (ajax.readyState==4) {\n";									
$contenidoAjax.="		div_respuesta_ajax.innerHTML = ajax.responseText\n";	
$contenidoAjax.="	   }\n";
$contenidoAjax.="      }\n";
$contenidoAjax.="   ajax.send(null)\n";
$contenidoAjax.="   }\n";

$contenidoAjax.="</script>\n";
...
if($ajax=="true")
	$contenidoIndex.="    require(\"ajax/ajax.php\");\n";	
...
if($ajax=="true")
	$contenidoIndex.=		"\$mensaje.=\"<div id='div_respuesta_ajax' ></div><input type='button' value='Llamar a Ajax' onclick='ejemploAjax()' />\";\n\n";
