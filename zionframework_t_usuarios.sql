CREATE DATABASE  IF NOT EXISTS `zionframework` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `zionframework`;
-- MySQL dump 10.14  Distrib 5.2.9-MariaDB, for suse-linux-gnu (x86_64)
--
-- Host: localhost    Database: zionframework
-- ------------------------------------------------------
-- Server version	5.2.9-MariaDB-log
...
-- Dump completed on 2012-05-03 14:43:04
