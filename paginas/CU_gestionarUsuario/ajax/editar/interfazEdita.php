						...
						<table class="tabla" border="0" bgcolor="white">
							<tr>
								...
								<td>
									...
									<input type="text" tabindex="1"onkeypress="return validar_numero(event);" maxlength="8" id="cedula" name="cedula" value="'.$objDatosUsuario[0][1].'"/>
							...
							<tr>
								...
								<td>
									<input type="text" tabindex="2" name="nombres" id="nombres" font style="text-transform: uppercase" value="'.$objDatosUsuario[0][2].'" />
								</td>
						 	</tr>
						 	...
						 	<tr>
								...
								<td>
									<input type="text" tabindex="3" name="apellidos" id="apellidos" font style="text-transform: uppercase" value="'.$objDatosUsuario[0][3].'"/>
								</td>
						 	</tr>
							...
							<tr>
								...
								<td>
									<input type="password" tabindex="4" name="clave" id="clave" maxlength="15" value="'.$objDatosUsuario[0][5].'" />
								</td>
							</tr>';
							...
							<tr>
								<td align="center" colspan="2">
									<br/>
									<input type="button" tabindex="6" value="Guardar" onclick="validarTodosLosCamposActualizar()" />
