...
//////////////////////////////////////////////////////////////////
	...
	function llamarGuardarNuevoUsuario()
	{
		...
		var rsecreta = document.getElementById('rsecreta').value;
			...
			ajax=nuevoAjax();
			ajax.open('GET', 'ajax/nuevoUsuario/guardarNuevoUsuario.php?id_usuario='+id_usuario+'&cedula='+cedula+'&nombres='+nombres+'&apellidos='+apellidos+'&rol='+rol+'&clave='+clave+'&psecreta='+psecreta+'&rsecreta='+rsecreta,true);
