       ...
       //==========================================================
			...
			function select($atributo, $tabla, $condicion, $groupBy,$ordenBy){
				...
				//se conecta a la base de datos
					...
					$SQL='SELECT ';
					//armamos la sentencia en lenguaje SQL que vera el desarrollador en pantalla
					$SQL_PRINT='<div style="background:#0E0E0E;"><font color="white">SELECT </font>';
					...
					//incluimos el campo que toca en el buble a la consulta SQL
						$SQL.= $valor;
						$SQL_PRINT.= '<font color="#DAB429">'.$valor;
					...
					//from
					$SQL.=  ' FROM ';
					$SQL_PRINT.=  '<font color="white"> FROM </font>';
					...
					if($condicion[0]!=""){ 	
						...
						//incluimos el campo que toca en el buble a la consulta SQL
							...
							//ponemos una coma para separar campo por campo y respetar la sintaxsis del lenguaje SQL
							$SQL.=' AND ';
							$SQL_PRINT.='</font><font color="white"> AND </font>';
						}
